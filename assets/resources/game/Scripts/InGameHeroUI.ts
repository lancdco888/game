...
import HeroInfoUI, { HeroInfoUIType } from "../../../Script/Hero/HeroInfoUI";
import HeroMainPopup, { TypeHeroSubPopup } from "../../../Script/Hero/HeroMainPopup";
import ServiceInfoManager from "../../../Script/ServiceInfoManager";
import UserInfo, { MSG } from "../../../Script/User/UserInfo";
import { HeroBuffPromotion } from "../../../Script/User/UserPromotion";
import HeroTooltipPopup, { HT_MakingInfo } from "../../../Script/Utility/HeroTooltipPopup";
import TSUtility from "../../../Script/global_utility/TSUtility";
import { Utility } from "../../../Script/global_utility/Utility";
import CenturionCliqueManager from "../../../Script/manager/CenturionCliqueManager";
    ...
    onLoad() {
        ...
        if (this.btn) {
            this.btn.clickEvents.push(
                Utility.getComponent_EventHandler(this.node, "InGameHeroUI", "onClickBtn", "")
            );
        }
    }
