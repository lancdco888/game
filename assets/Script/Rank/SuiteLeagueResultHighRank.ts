...
// ===================== 联赛高级排名展示组件(4-300名) 继承cc.Component =====================
@ccclass
export default class SuiteLeagueResultHighRank extends cc.Component {
    ...
    // ===================== 公有核心方法 - 打开高级排名展示 赋值所有UI数据+排名后缀逻辑 =====================
