import { _decorator, Component, Node, Vec2, Color, Label, LabelOutline, instantiate, director, Canvas, loader, Asset } from 'cc';
...
export default class HRVSlotService extends Component {
    // 单例实例
    private static _instance: HRVSlotService | null = null;
    ...
    private _inGameUI: {
        ...
        setPromotionUI: () => void;
        suiteLeagueUI: { feverUI: { updateFeverMode: (enable: boolean) => void; prefabFeverEffect: Node; setFeverEffectNode: (node: Node) => void; isPlayFeverTime: () => boolean; playFeverTime: () => void; refreshFeverLevel: () => void }; setLoungeSlotInfo: () => void; playStartAni: () => void };
        ...
        showBlockingBG: () => void;
        hideBlockingBG: () => void;
        thrillWheelJackpotGaugeUI: Node;
        piggyBankUI: { isReadyMaxMoneyPopOpen: () => boolean; resetReadyMaxMoneyPopOpen: () => void; showPiggyBankOfferPopup: () => void };
        iconSupersizeIt: { node: Node; initialize: () => void; playOpenAnimation: () => void };
        checkTooltip: () => void;
        updateUnlockContents: (callback: () => void) => void;
        setFastModePosition: (root: Node) => void;
        showFastModeTooltip: (isFast: boolean) => void;
        _isOpenPaytablePopup: boolean;
        payTable_IntoduceCoin: Node;
        btnSpin: { node: Node };
        nodeNewSlotTooltip: Node;
        nodeTotalBetUI: Node;
        setIntroduceCoin: () => void;
        startRecentlyPlayedTutorial: () => void;
    } = {} as any;
    private _hrvSlotBigWinEffectService: HRVSlotBigWinEffectService | null = null;
    private _feverModeIcon: IngameSuiteLeagueFeverToolTipUI | null = null;
    private _hyperBountyIngameIcon: HyperBountyInGameUI | null = null;
    ...
    private _changeResultThrillJackpotItemInfo: ChangeResult | null = null;
    public popupCustomMessage: Node | null = null;
    ...
    private _tooltip: HeroTooltipPopup | null = null;
    public popupLockTotalBet: HeroTooltipPopup | null = null;

    /**
     * 获取单例实例
     */
    public static instance(): HRVSlotService | null {
    ...
    public static createInstance(): void {
        if (HRVSlotService._instance === null) {
            const node = new Node("HRVSlotService");
    ...
    async onInit(): Promise<void> {
        try {
            ...
            if (SlotManager.Instance.machineFrameLayer) {
                const machineFramePrefab = instantiate(SlotPrefabManager.Instance().getPrefab("machineFrame"));
            ...
            if (SlotManager.Instance.backgroundLayer) {
                if (SlotPrefabManager.Instance().isPrefabExist("BackgroundSide")) {
                    const bgSide = instantiate(SlotPrefabManager.Instance().getPrefab("BackgroundSide"));
                    ...
                    bgSide.setPosition(Vec2.ZERO);
                }
                const bg = instantiate(SlotPrefabManager.Instance().getPrefab("Background"));
            ...
            if (SlotManager.Instance.bottomUiInstance) {
                ...
                const bottomUIPrefab = instantiate(SlotPrefabManager.Instance().getPrefab("bottomUI"));
            ...
            if (!TSUtility.isLiveService() && SlotManager.Instance.cheatObjectLayer) {
                const cheatPrefab = instantiate(SlotPrefabManager.Instance().getPrefab("cheatObject"));
            ...
            this.showLoginErrorPopup();
            FireHoseSender.Instance().sendAws(FireHoseSender.Instance().getRecord(FireHoseSender.FHLogType.Exception, error as Error));
        }
    }
     ...
     * 获取大奖硬币目标节点
     */
    getInGameBigwinCoinTarget(): Node {
    ...
    setFeverModeUI(): void {
        if (this.isAvailableFeverMode()) {
            ...
            if (TSUtility.isValid(feverUI) && SlotManager.Instance.machineFrame?.nodeFeverEffectRoot) {
                const feverEffect = instantiate(feverUI.prefabFeverEffect);
                if (feverEffect) {
                    SlotManager.Instance.machineFrame.nodeFeverEffectRoot.addChild(feverEffect);
                    feverEffect.setPosition(Vec2.ZERO);
    ...
    async tourneyInGameSchedule(): Promise<void> {
        ...
        try {
            ...
            const isComplete = await SlotTourneyManager.Instance().asyncCheckCompleteParticipateTourney(isTourney, tourneyId, tourneyTier);
            if (!isComplete) {
                return;
            }
     ...
     * @param target 目标节点
     */
    async asyncWaitEndBonusGameTooltip(parent: Node, target: Node): Promise<HeroTooltipPopup | null> {
    ...
    onSpinProcess(res: any, changeResult: ChangeResult): void {
        ...
        const jiggyPuzzleHist = changeResult.getPromotionHist(UserPromotion.JiggyPuzzlePromotion.PromotionKeyName);
        if (jiggyPuzzleHist) {
    ...
    onAfterSpinProcess(res: any, changeResult: ChangeResult): void {
        const newUserMissionHist = changeResult.getPromotionHist(UserPromotion.NewUserMissionPromotion.PromotionKeyName);
    ...
    getCheckFeverModeTime = function() {
        ...
        return t.addOnStartCallback(function() {
            if (0 != e.isAvailableFeverMode()) {
                ...
                if (0 != TSUtility.isValid(n) && 1 != n.isPlayFeverTime()) {
    ...
    getShowSpinEndPopup = function() {
        var e = new SequencialState
            , t = 0;
        return 1 == TSUtility.isTestDirectSlotMode() ? e.insert(0, this.getApplyGameResultProsess()) : (e.insert(t++, this.changeSuiteLeagueRank()),
    ...
    getCheckUnlockContents = function() {
        var e = this
            , t = new State;
        return t.addOnStartCallback(function() {
            0 != SlotGameResultManager.Instance.isBaseGameNextSubGameKey() ? e.getInGameUI().updateUnlockContents(function() {
                1 == PopupManager.Instance().isOpenPopupOpen() ? e.scheduleOnce(function() {
    ...
    getCheckPiggyBankPopup = function() {
        var e = this
            , t = new State;
        return t.addOnStartCallback(function() {
            0 != SlotGameResultManager.Instance.isBaseGameNextSubGameKey() ? (1 == e._inGameUI.piggyBankUI.isReadyMaxMoneyPopOpen() && (e._inGameUI.piggyBankUI.resetReadyMaxMoneyPopOpen(),
            0 == MessageRoutingManager.instance().isSpinOpenPopup(["RecordBreaker", "EpicWin"]) && e._inGameUI.piggyBankUI.showPiggyBankOfferPopup()),
            MessageRoutingManager.instance().resetSpinOpenPopup(),
    ...
    getCheckSupersizeIt = function() {
        var e = this
            , t = new State;
        return t.addOnStartCallback(function() {
            0 != SupersizeItManager.instance.isAvailablePromotion() ? (1 == TSUtility.isValid(e._inGameUI) && 1 == TSUtility.isValid(e._inGameUI.iconSupersizeIt) && 1 == SupersizeItManager.instance.isEnableEvent() && 0 == e._inGameUI.iconSupersizeIt.node.active && (SupersizeItManager.instance.initialize(),
            ...
            1 != SupersizeItManager.instance.isReservationOpenPopup() ? t.setDone() : e.openInGamePopup("SuperSizeItLobby", function() {
    ...
    getCheckHyperBountySeasonMissionComplete = function() {
        ...
        return e.addOnStartCallback(function() {
            if (0 != Ge.default.instance._arrCompletedSeasonMissionArray.length) {
                for (var t = 0; t < Ge.default.instance._arrCompletedSeasonMissionArray.length; t++) {
                    var n = Ge.default.instance._arrCompletedSeasonMissionArray[t];
                    1 == TSUtility.isValid(n) && (n.hyperBountyMissionInfo.numMissionID <= 401 && n.hyperBountyMissionInfo.numMissionID >= 101 || 901 == n.hyperBountyMissionInfo.numMissionID) && (PopupManager.Instance().addOpenPopup(n.openPopupInfo),
                    Ge.default.instance._arrCompletedSeasonMissionArray[t] = null)
                }
                e.setDone()
            } else
                e.setDone()
            ...
            if (null != e._changeResultThrillJackpotItemInfo) {
                for (var n = e._changeResultThrillJackpotItemInfo, o = null, a = 0; a < n.itemHist.length; ++a)
                    if ("" != n.itemHist[a].changeInfo) {
                        (o = new Se.default).parse(JSON.parse(n.itemHist[a].changeInfo));
                        break
                    }
                var i = new State;
                i.addOnStartCallback(function() {
                    var t = e.getInGameUI().thrillWheelJackpotGaugeUI.getComponent(me.default);
                ...
                r.addOnStartCallback(function() {
                    ye.default.getPopup(function(t, n) {
                        ...
                        n.setCloseCallback(function() {
                            e.getInGameUI().thrillWheelJackpotGaugeUI.getComponent(me.default).setInteractiveIconBtn(true),
                            e.getInGameUI().setStateBlockInput(false),
                            r.setDone()
                        })
                    })
                ...
                s.addOnStartCallback(function() {
                    e.getInGameUI().thrillWheelJackpotGaugeUI.getComponent(me.default).setCurrentGauge(true),
                    s.setDone()
                }),
                t.insert(0, i),
                t.insert(1, l),
    ...
    saveThrillJackpotItemInfo = function() {
        ...
        return t.addOnStartCallback(function() {
            ...
            var l = [B.default.TripleThrillSilver, B.default.TripleThrillGold, B.default.TripleThrillDiamond, B.default.TripleThrillJackpotSilver, B.default.TripleThrillJackpotGold, B.default.TripleThrillJackpotDiamond];
    ...
    getApplyGameResultProsess = function() {
        ...
        return t.addOnStartCallback(function() {
            ...
            var r = B.default.GetCasinoJackpotPay(SlotManager.Instance.getZoneId())
                    ...
                    return l(n, void 0, void 0, function() {
                        ...
                        return r(this, function(r) {
                            ...
                            case 1:
                                ...
                                1 == (c = G.default.getServerChangeResult(n)).getCheckByPayCode(B.default.SlotBetWithdraw) && (MessageRoutingManager.NUMBER_BET_SPIN_COUNT++,
    ...
    onApplyGameResultMoney = function(e) {
        1 == this._spinChangeResult.removeChangeCoinByPayCodeAndMoney(B.default.SpinResultPay, e) && UserInfo.instance().addUserAssetMoney(e)
    }
    
    onApplyGameResultMoneyBySubFromResult = function(e) {
        1 == this._spinChangeResult.subChangeCoinByPayCodeAndMoney(B.default.SpinResultPay, e) && UserInfo.instance().addUserAssetMoney(e)
    }
   
    onApplyGameResultMoneyByMaxMoneyFromResult = function(e) {
        var t = this._spinChangeResult.subChangeCoinByPayCodeAndMaxMoney(B.default.SpinResultPay, e);
        t > 0 && UserInfo.instance().addUserAssetMoney(t)
    }
    
    setSymbolSpecialInfo = function(e, t) {
        0 != SlotFeverModeManager.instance.isOpenFeverMode() && (SlotFeverModeManager.instance.createFeverIcon(new Oe.FeverSymbolInfo(e,SlotManager.Instance.getSymbolWidth(),SlotManager.Instance.getSymbolHeight(t))),
        e.once("sendSpecialModeMessage", function(t) {
            (t & I.SpecialType.FEVER) > 0 && SlotFeverModeManager.instance.moveFeverSymbolToFeverUILayer(e)
        }))
    }
    ...
    onSpinUserAssetChange = function(e) {
        ...
        Be.default.instance.addSpinBoosterExp(e)
    }
    
    onSetCurrentBetPerLine = function(e) {
        var t = e
            , n = SlotGameRuleManager.Instance.getBetMoney(t);
        if (1 ==SDefine.LevelBettingLock_Flag) {
            var o = UserInfo.instance().getZoneId();
            if (1 == LevelBettingLockConfig.Instance().isUseLevelBettingLock(o)) {
                var a = LevelBettingLockConfig.Instance().getZoneInfo(o).getNextLevelBetLock_LevelInfo(MessageRoutingManager.instance().getUserLevel());
        ...
        1 == SlotGameRuleManager.Instance._flagLockIncreaseBetMoneyUpperGuideBetPerLine && SlotGameRuleManager.Instance._guideBetPerLine < t && (t = SlotGameRuleManager.Instance._guideBetPerLine);
        var s = UserInfo.instance().getPromotionInfo(Ie.WelcomeBonusPromotion.PromotionKeyName)
            , c = TSUtility.isValid(s) && 0 == s.isReceived;
        return 0 == UserInfo.instance().getTotalCoin() && c && 0 == UserInfo.instance().isJoinTourney() && SlotGameRuleManager.Instance.slotID ==SDefine.TUTORIAL_SLOTID && SlotManager.Instance.getZoneId() ==SDefine.HIGHROLLER_ZONEID && (t =SDefine.tutorialBetLine),
        t
    }
    
    onSpinProcessRenewal_STATE_CUSTOM_ACTIVE_SPINBUTTON = function() {
        var e = this;
        null == this.popupCustomMessage && W.default.getCommonPopup(function(t, n) {
    ...
    openNotEnoughMoneyShopPopup = function() {
        ...
        if (0 != this._isEnableAllinRoot) {
            ...
            1 ==SDefine.FB_Instant_iOS_Shop_Flag)
    ...
    checkSpinAll = function() {
        var e = UserInfo.instance().getPromotionInfo(Ie.NewUserMissionPromotion.PromotionKeyName);
        return !(1 == TSUtility.isValid(e) && 1 == e.isNewTarget) || 0 != ClubVaultPopup.getAsBoolean(StorageKeyType.NEW_IN_GAME_TUTORIAL)
    }
    ...
    getMaintainBetPerlines = function() {
        ...
        1 == LevelBettingLockConfig.Instance().isUseLevelBettingLock(SlotManager.Instance.getZoneId())) {
    ...
    getSlotJackpotInfo = function(e) {
        ...
        return Ae.default.Instance().getSlotmachineInfo(t, e)
    }
    
    onProcessEndPopup = function(e) {
        if ((1 ==SlotReelSpinStateManager.Instance.getFreespinMode() && e.currentShowingPopupType == g.ResultPopupType.FreespinResult || 0 ==SlotReelSpinStateManager.Instance.getFreespinMode() && e.currentShowingPopupType != g.ResultPopupType.LinkedJackpotResult) && fe.default.instance().reserveNewRecordPopup(e.currentShowingMoney),
        0 ==SlotReelSpinStateManager.Instance.getFreespinMode() && e.currentShowingPopupType == g.ResultPopupType.LinkedJackpotResult) {
            var t = SlotGameResultManager.Instance.getSubGameState("freeSpin");
            (null != t && t.spinCnt == t.totalCnt || null == t) && fe.default.instance().reserveNewRecordPopup(e.currentShowingMoney)
        }
    }
    ...
    onCheckFeverAbleSymbol = function() {
        ...
        SlotManager.Instance._special_select_cell[I.SpecialType.FEVER] = SlotFeverModeManager.instance.getCellWithDrawLots(t)
    }
    ...
    onInitBottomUI_EX2 = function(e) {
        ...
        UserInfo.instance().addListenerTarget(UserInfo.MSG.RELEASE_BETTINGLOCK, function() {
            t.addMaxBettingUnlockEffect(e.btnPlusBetPerLine.node)
        }, this),
        e.powerGemSlotBottomIconPos) {
            var n = N.default.Instance().getPrefab("Service/01_Content/PowerGem/PowerGemSlotBottomIcon")
                , o = cc.instantiate(n);
            this._powerGemSlotBottomIcon = o.getComponent(X.default),
        ...
        if (e.nodeFeverIconPos) {
            n = N.default.Instance().getPrefab("Service/01_Content/FeverMode/FeverModeIcon");
            var l = cc.instantiate(n);
            this._feverModeIcon = l.getComponent(_.default),
        ...
        if (e.hyperBountySlotBottomIconPos) {
            ...
            cc.loader.loadRes("Service/01_Content/HyperBounty/IngameHyperBounty/HyperBounty_" + e.node.name, function(n, o) {
                ...
                t._hyperBountyIngameIcon = s.getComponent(Ue.default),
            ...
            a.openCallback = function() {
                ...
                cc.loader.loadRes(t, function(o, a) {
                    if (o) {
                        ...
                        u.default.Instance().sendAws(u.default.Instance().getRecord(u.FHLogType.Exception, i))
                    } else {
    ...
    checkLoungeNewSlot = function(e) {
        if (0 != SlotManager.Instance.IsLoungeNewSlot()) {
            ...
            0 != SlotManager.Instance._initFinish &&SlotReelSpinStateManager.Instance.getCurrentState() == M.defaulState_STOP && (t >= 27e5 && (this._activeNewSlotTooltip = false,
        ...
        return l(this, void 0, void 0, function() {
            ...
            return r(this, function(r) {
                ...
                case 1:
                    ...
                    0 == TSUtility.isValid(this) || 0 == TSUtility.isValid(this._tooltip) || 0 == TSUtility.isValid(t) ? [2] : (a = null != t && null != e.nodeTotalBetUI && t.name == e.nodeTotalBetUI.name,
                    i = {
                        settingInfo: {
                            useBlockBG: false,
                            useBlockFrame: true,
                    ...
                    s = function() {
                        1 == TSUtility.isValid(c._tooltip) && c._tooltip.close()
                    }
                    ,
    ...
    onSetButtonActiveState_EX2 = function() {
        var e = UserInfo.instance().getPromotionInfo(Ie.NewServiceIntroduceCoinPromotion.PromotionKeyName);
    ...
    onClickPaytableBtn = function() {
        ...
        1 == TSUtility.isTestDirectSlotMode() ? LevelBettingLockConfig.getPopup(function(t, n) {
    ...
    onInitUI_BottomUIText = function(e) {
        UserInfo.instance().addListenerTarget(UserInfo.MSG.UPDATE_ASSET, function() {
            e.setMyMoney()
        }, e)
    }
    ...
    showClubVaultUpgradePopup = function() {
        ...
        e.openCallback = function() {
            ...
            ClubVaultPopup.getPopup(function(e, t) {
                PopupManager.Instance().showDisplayProgress(false),
                1 != TSUtility.isValid(e) ? (t.setCloseCallback(function() {
                    PopupManager.Instance().checkNextOpenPopup()
                }),
    ...
    sendChangeBalanceID = function(e, t) {
        G.default.Instance().requestMultiBalance(SlotGameRuleManager.Instance.slotID, e, function(e, n) {
