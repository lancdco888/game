...
import LobbyUI_Bankroll from "../Lobby/LobbyUI_Bankroll";
import LobbyUI_Coupon from "../Lobby/LobbyUI_Coupon";
import LobbyUI_Hero from "../Lobby/LobbyUI_Hero";
import LobbyUI_LevelBooster from "../Lobby/LobbyUI_LevelBooster";
import LobbyUI_Profile from "../Lobby/LobbyUI_Profile";
...
export default class CommonRewardNodes extends cc.Component {
    ...
    public nodeInGameHeroIcon: InGameHeroUI = null;
